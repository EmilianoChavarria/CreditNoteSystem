...
export class BulkTemplateService {
  ...
  private readonly definitions: Record<BulkTemplateType, BulkTemplateDefinition> = {
    distributors: {
      ...
      headers: ['clientNumber', 'businessName', 'taxId', 'address', 'emails', 'countrycode', 'salesEngineerId', 'salesManagerId'],
      sampleRows: [
    ...
    nationalCustomers: {
      ...
      headers: ['customerNumber', 'emails', 'returnPercentage', 'currency'],
      sampleRows: [
    ...
    productClassification: {
      ...
      headers: ['idProducto', 'clasificacion'],
      sampleRows: [
